...
public class InvoiceDisconnectionFunction implements RequestHandler<APIGatewayV2WebSocketEvent, APIGatewayV2WebSocketResponse> {
	...
	public APIGatewayV2WebSocketResponse handleRequest(APIGatewayV2WebSocketEvent input, Context context) {
		...
		this.logger.log(Level.INFO, "InvoiceDisconnectionFunction start connectionId: {0}" ,input.getRequestContext().getConnectionId());
